## humdrum-bach-brandenburg Makefile
##
...
##                for the J.S. Bach's Brandenburg concertos.
##
...
#           git clone https://github.com/musedata/humdrum-bach-brandenburg
#
...
kernscores: humdrum-extras-check
	mkdir -p kernscores; (cd kernscores && humsplit h://brandenburg)
	@echo "[0;32m"
...
ifeq ($(wildcard .git),)
	...
	@echo "***    [0;32mgit clone https://github.com/musedata/humdrum-bach-brandenburg
	@echo "[0m"
	exit 1
endif
